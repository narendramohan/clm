...
public class TextClassifier {
    ...
    public static void main(String args[]) {
        ...
        String[] inputText =  {"hey, buy this from me!", "do you want to buy?", "I have a party tonight!", 
        		"today it is a nice weather","you are best","I have a horse","you are my friend",
        		"buy, buy, buy!","it is spring in the air", "do you want to come?"};
    ...
    public StringBuffer classify(String classString) {
        ...
        try {
            ...
            //
            classifier = SimpleLinearRegression.forName(classString,null);
