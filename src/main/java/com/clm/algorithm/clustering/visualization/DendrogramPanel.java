package com.clm.algorithm.clustering.visualization;
...
import com.clm.algorithm.clustering.AvgLinkageStrategy;
...
public class DendrogramPanel extends JPanel {
    ...
    private static Cluster createSampleCluster() {
        ...
        Cluster cluster = alg.doClustering(distances, names, new AvgLinkageStrategy());
        cluster.toConsole(0);
        return cluster;
    }
