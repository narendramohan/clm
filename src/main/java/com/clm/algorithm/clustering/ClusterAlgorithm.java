...
public class ClusterAlgorithm implements ClusteringAlgo {

    @Override
    public Cluster doClustering(double[][] distances,
    ...
    public Cluster doWeightedClustering(double[][] distances, String[] clusterNames,
        ...
        return doClustering(distances, clusterNames, linkageStrategy);
    }
